...
pub fn loading_button_component(props: &LoadingButtonProps) -> Html {
    ...
    <button
      type="submit"
      class={format!(
        "w-full py-1 md:py-3 font-semibold rounded-lg outline-none border-none flex justify-center {}",
